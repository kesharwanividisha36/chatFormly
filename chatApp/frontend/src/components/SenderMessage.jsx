...
function SenderMessage({image,message}) {
  ...
  return (
   <div className='flex items-start gap-[10px]' >
         ...
         <div ref={scroll} className='w-fit max-w-[500px] px-[20px] py-[10px]  bg-[#28b00d] text-white text-[19px] rounded-tr-none rounded-2xl relative right-0 ml-auto shadow-gray-400 shadow-lg gap-[10px] flex flex-col'>
